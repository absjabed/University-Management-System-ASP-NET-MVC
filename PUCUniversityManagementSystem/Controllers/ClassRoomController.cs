    ...
    public class ClassRoomController : Controller
    {
        ...
        public ActionResult Save(ClassRoom classRoom)
        {
            try
            {
                ...
                ViewBag.alart = classRoomManager.Save(classRoom);
        ...
        {
            ViewBag.alart = new AlartType("Unassign all the class rooms.", "danger");
            return View();
        }
        [HttpPost]
        public ActionResult UnAllocateClassRoom(int? id)
        {
            ViewBag.alart = classRoomManager.UnAllocateClassRoom();
            return View();
        }
    }
}
