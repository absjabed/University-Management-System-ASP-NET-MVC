...
namespace UniversityManagementSystem.Gateway
{
    public class ClassRoomGateway:DBGateway
    {
        public int Insert(ClassRoom room)
        {
            ...
            {
                string query =
                    "INSERT INTO AllocateClassRoom VALUES(@deptId,@courseId,@roomId,@dayId,@StartTime,@endTime,@allocationStatus)";
        ...
        public List<ClassRoom> GetClassSchedulByStartAndEndingTime(int roomId, int dayId, DateTime startTime, DateTime endTime)
        {
            try
            {
                ...
                CommandObj.CommandText = "Select * from AllocateClassRoom Where DayId=" + dayId + " AND RoomId="+roomId+" AND AllocationStatus=" + 1;
        ...
        public int UnAllocateClassRoom()
        {
            ...
            try
            {
                CommandObj.CommandText = "UPDATE AllocateClassRoom SET AllocationStatus=0";
