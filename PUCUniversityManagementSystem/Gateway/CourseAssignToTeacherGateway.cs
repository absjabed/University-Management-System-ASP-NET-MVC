    ...
    public class CourseAssignToTeacherGateway:DBGateway
    {
        ...
        public int Insert(CourseAssignToTeacher courseAssign)
        {
            ...
            try
            {
                ...
                CommandObj.CommandText = "INSERT INTO CourseAssignToTeacher VALUES(@deptId,@teacherId,@courseId,@status)";
        ...
        private int UpdateTeacher(CourseAssignToTeacher courseAssign)
        {
            ...
            CommandObj.CommandText = "Update Teacher Set CreditTaken='" + creditTakenbyTeacher + "' WHERE Id='" +
        ...
        public IEnumerable<CourseAssignToTeacher> GetAll 
        {
            get
            {
                try
                {
                    CommandObj.CommandText = "SELECT * FROM CourseAssignToTeacher";
        ...
        //        CommandObj.Transaction = sqlTransaction;
        //        CommandObj.CommandText = "UPDATE CourseAssignToTeacher SET IsActive=1 WHERE TeacherId='" + courseAssign.TeacherId + "' AND CourseId='"+courseAssign.CourseId+"'";
