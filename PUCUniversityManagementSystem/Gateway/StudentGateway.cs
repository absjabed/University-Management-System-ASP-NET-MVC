...
namespace UniversityManagementSystem.Gateway
{
    public class StudentGateway : DBGateway
    {
        ...
        public int Insert(EnrollStudentInCourse enrollStudent)
        {
            try
            {
                CommandObj.CommandText = "INSERT INTO StudentEnrollInCourse VALUES(@stId,@courseId,@enrollDate,@status)";
                CommandObj.Parameters.Clear();
        ...
        public IEnumerable<EnrollStudentInCourse> GetEnrollCourses
        {
            get
            {
                try
                {
                    CommandObj.CommandText = "SELECT * FROM StudentEnrollInCourse";
        ...
        public int Insert(StudentResult studentResult)
        {
            try
            {
                CommandObj.CommandText = "INSERT INTO StudentResults VALUES(@stId,@courseId,@grade,@isStudentActive)";
                CommandObj.Parameters.Clear();
        ...
        public IEnumerable<StudentResult> GetAllResult
        {
            get
            {
                try
                {
                    CommandObj.CommandText = "SELECT * FROM StudentResults";
        ...
        {
            CommandObj.CommandText = "UPDATE StudentResults SET IsStudentActive=1,Grade='" + studentResult.Grade + "' WHERE StudentId='" +
                                     studentResult.StudentId + "' AND CourseId='" + studentResult.CourseId + "'";
            ConnectionObj.Open();


            int row = CommandObj.ExecuteNonQuery();
            ConnectionObj.Close();
            return row;
        }
    }
