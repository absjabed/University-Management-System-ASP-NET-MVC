...
namespace UniversityManagementSystem.Gateway
{
    public class CourseGateway:DBGateway
    {
        ...
        public int UnAssignCourse()
        {
            ...
            try
            {
                CommandObj.CommandText = "UPDATE CourseAssignToTeacher SET IsActive=0";
        ...
        {
            CommandObj.CommandText = "UPDATE StudentResults SET IsStudentActive=0";
            return CommandObj.ExecuteNonQuery();
        }
        ...
        {
            CommandObj.CommandText = "UPDATE StudentEnrollInCourse SET IsStudentActive=0";
            return CommandObj.ExecuteNonQuery();
        }
